...
Particularly, we're using the [**Llama2-13B**](https://replicate.com/meta/llama-2-13b-chat) model deployed by the Andreessen Horowitz (a16z) team and hosted on the [Replicate](https://replicate.com/) platform.
...
As mentioned above, this chatbot implementation uses the [**Llama2-13B**](https://replicate.com/meta/llama-2-13b-chat) model that was trained on 7 billion parameters.
